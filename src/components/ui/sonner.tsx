    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          error:
            "group-[.toaster]:bg-destructive/50 group-[.toaster]:border-destructive group-[.toaster]:text-destructive-foreground group-[.toaster]:hover:bg-destructive/50 !text-destructive-foreground/90",
          warning:
